...
export class AppComponent implements OnInit{
  ...
  questionCollapse(index){
    ...
    if(document.getElementById('demo'+index).className === "collapse")
      document.getElementById('demo'+index).className="show";
    else
    document.getElementById('demo'+index).className="collapse";
  }

  addQuestion(){
    this.questions.push("How are you ?");
  }
        ...
        blockManager: {
          ...
          blocks: [
            ...
            ,{
              ...
              id:"Field",
              label:'Field',
              content:'<span onclick="runit()"> _______ </span>'
            },{
              id:"OfflineField",
              label:'Offline Field',
              content:'<span> ............................................................................................................... </span>'
